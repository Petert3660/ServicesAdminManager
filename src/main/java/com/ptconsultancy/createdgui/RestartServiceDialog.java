...
public class RestartServiceDialog extends JFrame {
    ...
    private RestartServiceDialog tg = this;
    ...
    @Autowired
    public RestartServiceDialog(MainDialog mainDialog, Admin admin) {
        this.admin = admin;
        ...
        FreeLabelComboBoxPair comp0 = new FreeLabelComboBoxPair(col, "Please select service to restart:", 30, 90, 240, items0);
